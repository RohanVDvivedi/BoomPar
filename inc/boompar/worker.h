...
int start_worker(
					...
					job_queue* job_q, 								// ** the worker thread uses this job_queue to receive jobs to finish
...
// For the below submit_job_worker functions, the timeout is the time you intend to wait until submission is successfull
